...
export class Dropdown{
	...
	constructor(dd,index){
		...
		this.guest = this.dd.hasClass('js-guest-dropdown-body')
	...
	getLcKey(){
		...
		let ind = this.guest?str.indexOf('guest-dropdown-body_active'):str.indexOf('dropdown-body_active')
		ind!=-1?
			str.splice(ind,1):0
	...
	toggle(){
		this.guest?this.dd.toggleClass('guest-dropdown-body_active'):this.dd.toggleClass('dropdown-body_active')
